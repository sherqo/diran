...
//         children: [{ text: 'This editor has upload handlers disabled (demo mode).' }],
//     },
//     {
//         type: 'paragraph',
//         children: [{ text: 'Start typing, experiment with plugins, and re-enable upload handlers when you need them.' }],
//     },
// ];

// export default WITH_BASIC_INIT_VALUE;
